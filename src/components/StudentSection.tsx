...
import { STUDENT_EVENTS, PLACEMENTS, } from '../data/collegeData';
              ...
              {PLACEMENTS.map((item, idx) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-brand-gold font-semibold mt-1 block">Rotations & Job-Offers: {item.category}</span>
                  </div>
                </div>
              ))}
            </div>
